...
* 数组 Array
  ...
  - [X] [[https://leetcode-cn.com/problems/search-in-rotated-sorted-array/][LC033]] [[file:ch01_array/lc033.go][搜索旋转排序数组]] 由于值互不相同，采用二分查找，注意下标的处理，【数组二分，必有一半有序，判断 target 是否在有序数组里】
  - [X] [[https://leetcode-cn.com/problems/search-in-rotated-sorted-array-ii/][LC081]] [[file:ch01_array/lc081.go][搜索旋转排序数组 II]] 注意二分查找，需要对于 a[mid] 和 a[beg] 相等时的特殊处理，防止死循环
  - [ ] [[https://leetcode-cn.com/problems/rotate-array/][LC189]] [[file:ch01_array/lc189.go][旋转数组]]
